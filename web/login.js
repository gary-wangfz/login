import '../component/common/utils/lib'
import {Form, Input, Row ,Col, Icon, Button, Alert} from 'antd';
const FormItem = Form.Item;
import Utils from '../component/common/utils/utils'
import AppService from '../component/common/utils/app.service'
            ...
            if (!err) {
                ...
                AppService.postRequest('/base/login/admin/login',values).then(result =>{
                    if(result.errorCode == 0) {
                        debugger
                        let url = sessionStorage.getItem('gotoBeforeUrl');
            ...
            <div className="width1004 login_c">
                <div className="indexcontent">
                    <div className="login_content">
                        <div className="l_title">OPPO账号</div>
